...
def decode_tsf(tsf: str):
  tsf = tsf.split(";%")
  if not tsf[0] in valid_tsf_schemas:
    raise InvalidSchemaException(f"Schema {tsf[0]} isn't supported")
  if len(tsf) != 12:
...
#decode_tsf(open("readable.tsf", 'r').read()) # print()
